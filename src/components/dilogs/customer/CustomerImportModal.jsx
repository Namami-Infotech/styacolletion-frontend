...
export const downloadCustomerDemoExcel = () => {
  const sampleRow1 = {
    ...
    "Village Name": "Connaught Place",
    "Center Name": "CP Center",
    "Center Code": "CNT01",
    "Member No.": "MEM-1001",
    ...
    "Reschedule": "No",
    "Loan NO.": "LN-1001",
    "LOAN series": "SER-2024",
    "OldLoanNo": "OLD-LN-801",
    "Cycle": 1,
    "LoanDisbDate": "2024-01-15",
    "LoanAmount": 50000,
    "O/S Prin": 40000,
    "O/S Int": 2000,
    "PAR": 0,
    ...
    "IrrRate": 12.5,
    "NoOfInstallment": 12,
    "LastDueDate": "2024-12-15",
    "LastPaidTrxDate": "2024-11-10",
    "LastTrxAmount": 5000,
    "DPD": 0,
    "PaidInstNo": "10",
    "LoanStatus": "Open",
    ...
    "Mapped Emp name": "EMP101",
    "Remarks": "Regular paying customer",
  };
  ...
  const sampleRow2 = {
    ...
    "Village Name": "Indiranagar",
    "Center Name": "MG Center",
    "Center Code": "CNT02",
    "Member No.": "MEM-1002",
    ...
    "Reschedule": "No",
    "Loan NO.": "LN-1002",
    "LOAN series": "SER-2023",
    "OldLoanNo": "OLD-LN-802",
    "Cycle": 2,
    "LoanDisbDate": "2023-06-10",
    "LoanAmount": 100000,
    "O/S Prin": 0,
    "O/S Int": 0,
    "PAR": 0,
    ...
    "IrrRate": 14.0,
    "NoOfInstallment": 24,
    "LastDueDate": "2024-06-10",
    "LastPaidTrxDate": "2024-06-05",
    "LastTrxAmount": 5000,
    "DPD": 0,
    "PaidInstNo": "24",
    "LoanStatus": "Closed",
    "SpouseName": "Rohan Patel",
    "Address": "MG Road, Bengaluru",
    "ContactNumber": "9812345678",
    "InstallmentAmount": 5000,
    "MaturityDate": "2024-06-10",
    "Mapped Emp name": "EMP102",
    "Remarks": "Loan completed on time",
  };
  ...
  try {
    ...
    const exportRows = dataToExport.map((c, idx) => {
      ...
      return {
        ...
        "Branch": c.branch || "",
        "Village Name": c.village_name || "",
        "Center Name": c.center || "",
        "Center Code": c.center_code || "",
        "Member No.": c.member_no || c.customer_id || "",
        "Member Name": c.name || "",
        "Status": c.loanStatus || "Open",
        "Purpose": c.purpose || "",
        "Loan Type": c.loanType || "",
        "Reschedule": c.reschedule || "",
        "Loan NO.": c.loanNo || "",
        "LOAN series": c.loan_series || "",
        "OldLoanNo": c.oldLoanNo || "",
        "Cycle": c.cycle !== null && c.cycle !== undefined ? c.cycle : "",
        "LoanDisbDate": c.loanDisbDate || "",
        "LoanAmount": c.loanAmount ? `₹${c.loanAmount}` : "₹0",
        "O/S Prin": c.os_principal ? `₹${c.os_principal}` : "₹0",
        "O/S Int": c.os_interest ? `₹${c.os_interest}` : "₹0",
        "PAR": c.par !== null && c.par !== undefined ? c.par : 0,
        "ODPrin": c.od_principal ? `₹${c.od_principal}` : "₹0",
        "ODInt": c.od_interest ? `₹${c.od_interest}` : "₹0",
        "TotalDueAmt": c.totalDueAmount ? `₹${c.totalDueAmount}` : "₹0",
        "TotalPrinColl": c.total_principal_collectible ? `₹${c.total_principal_collectible}` : "₹0",
        "TotalIntColl": c.total_interest_collectible ? `₹${c.total_interest_collectible}` : "₹0",
        "IrrRate": c.irrRate ? `${c.irrRate}%` : "",
        "NoOfInstallment": c.noOfInstallment || "",
        "LastDueDate": c.lastDueDate || "",
        "LastPaidTrxDate": c.lastPaidTrxDate || "",
        "LastTrxAmount": c.lastTrxAmount ? `₹${c.lastTrxAmount}` : "₹0",
        "DPD": c.dpd !== null && c.dpd !== undefined ? c.dpd : 0,
        "PaidInstNo": c.paidInstNo || "0",
        "LoanStatus": c.loanStatus || "Open",
        "SpouseName": c.spouseName || "",
        "Address": c.location || "",
        "ContactNumber": c.phone || "",
        "InstallmentAmount": c.installmentAmount ? `₹${c.installmentAmount}` : "₹0",
        "MaturityDate": c.maturityDate || "",
        "Mapped Emp name": ownerObj?.name ? `${ownerObj.name} (${ownerObj.identity || ownerObj.emp_id || ""})` : (c.owner || "N/A"),
        "Remarks": c.remarks || "",
      };
    });
